...
ActiveRecord::Schema[8.1].define(version: 2026_07_17_070000) do
  ...
  create_table "folders", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["is_public"], name: "index_folders_on_is_public"
    t.index ["parent_id"], name: "index_folders_on_parent_id"
    t.index ["user_id", "parent_id", "name"], name: "index_folders_on_user_id_and_parent_id_and_name", unique: true, nulls_not_distinct: true
  end
  ...
  add_foreign_key "documents", "documents", column: "copied_from_id", on_delete: :nullify
